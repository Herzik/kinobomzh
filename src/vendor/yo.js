...
function yo(self) {
  ...
  var sel = self && self.getAttribute('data-ahoy') ? self.getAttribute('data-ahoy') : 'yohoho'
  ...
  options.button_limit =
    options.button_limit && parseInt(options.button_limit) < 8 ? parseInt(options.button_limit) : 8
  options.button_size =
    options.button_size && parseFloat(options.button_size) ? parseFloat(options.button_size) : 1
...
function yo_resize() {
  ...
  if (!yi || !yi.parentNode || !yi.parentNode.parentNode || !yi.parentNode.parentNode.offsetWidth)
    return
